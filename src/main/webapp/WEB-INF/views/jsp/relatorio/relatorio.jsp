...
<div id="conteudo" class="">
	<div class="post">
		...
		<button onclick="window.location.href='${pageContext.request.contextPath}/categoria/cadastro'"><p><img alt="kkk" src="${pageContext.request.contextPath}/resources/images/categoria.png">Vendas</p></button>
		<button onclick="window.location.href='${pageContext.request.contextPath}/produto/cadastro'"><p><img alt="kkk" src="${pageContext.request.contextPath}/resources/images/produto.png">Devolucoes</p></button>
		<button onclick="window.location.href='${pageContext.request.contextPath}/usuario/cadastro'"><p><img alt="kkk" src="${pageContext.request.contextPath}/resources/images/user.png">Compra</p></button>
		<button onclick="window.location.href='${pageContext.request.contextPath}/garcon/cadastro'"><p><img alt="kkk" src="${pageContext.request.contextPath}/resources/images/garcon.png">Estoque</p></button>
