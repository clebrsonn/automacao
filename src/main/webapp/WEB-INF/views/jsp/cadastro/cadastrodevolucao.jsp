...
<div class="postt">
		<h2 class="title">Cadastros de Devolu��es</h2>


		<button onclick="window.location.href='/sushi/devolucaovenda/cadastro'"><p><img alt="kkk" src="${pageContext.request.contextPath}/resources/images/categoria.png">Venda</p></button>
		<button onclick="window.location.href='/sushi/devolucaocompra/cadastro'"><p><img alt="kkk" src="${pageContext.request.contextPath}/resources/images/produto.png">Compra</p></button>
