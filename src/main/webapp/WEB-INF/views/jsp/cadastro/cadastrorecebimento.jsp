	...
	<div id="form">
		<form id="formRecebimentos" action="add" method="POST">
			...
			<fieldset>
				...
				<legend>Dados do Pedido de Compra</legend>
					...
					<div id="dadospedido" class="dadospedido">
			            ...
			            ID Fornecedor:
			            <input name="idfornecedor" type="text" class="tipo" value="${pc.fornecedor }"/>
			...
			<!-- 			<input id="totalpedido" name="totalpedido" type="text" class="totalpedido" /> -->
						...
						Data Compra
						<input id="datacompra" name="data"  type="date" value="${pc.data}"
			...
			Data Recebimento
			<input id="data" name="data"  type="date" value="${recebimento.data}"
			<fmt:formatDate pattern="dd/MM/yyyy" value="${recebimento.data}"/>/>
