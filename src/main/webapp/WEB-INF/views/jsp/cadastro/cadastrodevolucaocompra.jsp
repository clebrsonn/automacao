...
<div id="conteudo" class="conteudo">
    ...
    <h3>Cadastro de Devolucao de Compra</h3>
                        ...
                        <c:when test="${item.id % 2 == 0}">
                            <tr class="alternate-row">
                                ...
                                <td class="options-width">
                                    <a href="edicaodevolucao?id=${devolucao.id}" class="icon-1 info-tooltip"
                                       title="Edit"></a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="/delete?id=${devolucao.id}" class="icon-4 info-tooltip" title="aaa"></a>
                                    <a href="cadastrodevolucao2?id=${devolucao.id}" class="icon-3 info-tooltip"
                                       title="bbb"></a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="movimentacaodevolucao/delete?id=${devolucao.id}"
                                       class="icon-5 info-tooltip" title="ccc"></a>
                                </td>
                            </tr>
                        </c:when>
                        <c:when test="${item.id % 2 != 0}">
