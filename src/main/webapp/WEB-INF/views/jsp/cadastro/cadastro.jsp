...
<div id="conteudo" class="">
	<div class="post">
		...
		<button onclick="window.location.href='cadastroservico'"><p><img alt="kkk" src="/resources/images/servico.png">serviço</p></button>
		<div><p></p></div>
		<button onclick="window.location.href='cadastromesa'"><p><img alt="kkk" src="/resources/images/mesa_disp.png">mesas</p></button>
		<button onclick="window.location.href='cadastrocomposicao'"><p><img alt="kkk" src="/resources/images/composicao.png">Composição</p></button>
		<button onclick="window.location.href='cadastrodesconto'"><p><img alt="kkk" src="/resources/images/desconto.png">desconto</p></button>
		<button onclick="window.location.href='cadastropromocao'"><p><img alt="kkk" src="/resources/images/promocao.png">promoção</p></button>
