...
<div id="conteudo" class="">
	<div class="post">
		...
		<button onclick="window.location.href='${pageContext.request.contextPath}/categoria/cadastro'"><p><img alt="kkk" src="${pageContext.request.contextPath}/resources/images/categoria.png">categorias</p></button>
		<button onclick="window.location.href='${pageContext.request.contextPath}/produto/cadastro'"><p><img alt="kkk" src="${pageContext.request.contextPath}/resources/images/produto.png">produtos</p></button>
		<button onclick="window.location.href='${pageContext.request.contextPath}/usuario/cadastro'"><p><img alt="kkk" src="${pageContext.request.contextPath}/resources/images/user.png">usuario</p></button>
		<button onclick="window.location.href='${pageContext.request.contextPath}/garcon/cadastro'"><p><img alt="kkk" src="${pageContext.request.contextPath}/resources/images/garcon.png">garcon</p></button>
		<button onclick="window.location.href='${pageContext.request.contextPath}/despesa/cadastro'"><p><img alt="kkk" src="${pageContext.request.contextPath}/resources/images/despesa.png">despesas</p></button>
		...
		<button onclick="window.location.href='${pageContext.request.contextPath}/promocao/cadastro'"><p><img alt="kkk" src="${pageContext.request.contextPath}/resources/images/promocao.png">promocao</p></button>
		<button onclick="window.location.href='${pageContext.request.contextPath}/reserva/cadastro'"><p><img alt="kkk" src="${pageContext.request.contextPath}/resources/images/reserva.png">reservas</p></button>
