...
<div class="postt">
		...
		<button onclick="window.location.href='/sushi/pedidovenda/movimentacao'"><p><img alt="kkk" src="${pageContext.request.contextPath}/resources/images/categoria.png">Venda</p></button>
		<button onclick="window.location.href='/sushi/pedidocompra/movimentacaopedidocompralista'"><p><img alt="kkk" src="${pageContext.request.contextPath}/resources/images/produto.png">Compra</p></button>
