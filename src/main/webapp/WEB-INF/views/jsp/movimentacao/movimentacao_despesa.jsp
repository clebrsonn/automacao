    ...
    <tr class="alternate-row">
                <td><input  type="checkbox"/></td>
                    ...
                    <td class="options-width">
                        <a href="edicaodespesa?id=${despesa.id}" class="icon-1 info-tooltip" title="Editar  Desenvolvedor"></a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="movimentacaodespesa/delete?id=${despesa.id}" class="icon-5 info-tooltip" title="Delete Desenvolvedor"></a>
                    </td>
                </tr>
  </c:when>
  <c:when test="${despesa.id % 2 != 0}">
