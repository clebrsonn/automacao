...
<div id="conteudo" class="">
	<div class="post">
		...
		<button onclick="window.location.href='garcon/movimentacao'"><p><img alt="kkk" src="${pageContext.request.contextPath}/resources/images/garcon.png">garcon</p></button>
		...
		<button onclick="window.location.href='composicao/movimentacao'"><p><img alt="kkk" src="${pageContext.request.contextPath}/resources/images/composicao.png">Composicao</p></button>
