...
<div id="conteudo" class="conteudo">
	...
	<div id="formAddItem">
	<form id="formAdd" action="movimentacaorecebimento/additemrecebimento" method="GET">


		ID do Pedido:
		<input name="idpedidocompra"type="text" class="idpedidocompra" />
		...
		Data Solicitacao:
		<input id="data" name="data" type="text" class="data" />
