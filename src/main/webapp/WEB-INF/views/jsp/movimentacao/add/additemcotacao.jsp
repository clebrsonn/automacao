...
<div id="conteudo" class="conteudo">
	...
	<h3>Add Item a Cotacao</h3>


	<div id="formAddItem">
		<form id="formAdd" action="additemrecebimento" method="GET">


			ID da Cotacao: <input name="idpedidocompra" type="text"
				class="idpedidocompra" /> ID fornecedor: <input name="tipo"
				type="text" class="tipo" /> Data Solicitacao: <input id="data"
				name="data" type="text" class="data" />
						...
						<c:when test="${item.id % 2 == 0}">
							<tr class="alternate-row">
								...
								<td class="options-width"><a
									...
									&nbsp;&nbsp;&nbsp;&nbsp; <a
									href="movimentacaorecebimento/delete?id=${item.id}"
