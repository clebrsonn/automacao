		...
		<div id="content-table">
			<form id="mainform" action="">
				...
				<table border="0" width="100%" cellpadding="0" cellspacing="0"
					...
					<th class="table-header-repeat line-left minwidth-1"><a>Nome
					</a></th>
...
<!-- 					<th class="table-header-repeat line-left minwidth-1"><a>Total</a></th> -->
					...
					<c:forEach var="estoque" items="${estoqueList}"
						varStatus="id">
...
<%-- 									<td>${pedido.total}</td> --%>
									...
									<td class="options-width"><a
										href="edicao?id=${estoque.id}" class="icon-1 info-tooltip"
										title="Edit"></a> &nbsp;&nbsp;&nbsp;&nbsp; <a
										href="cadastrovenda2?id=${estoque.id}"
										class="icon-40 info-tooltip" title="aaa"></a> <a
										href="additem?id=${estoque.id}"
										class="icon-30 info-tooltip" title="Adicionar Item ao Pedido"></a>
										&nbsp;&nbsp;&nbsp;&nbsp; <a href="delete?id=${estoque.id}"
...
<%-- 									<td>${pedidovenda.total}</td> --%>
				...
				<div id="botoes">
					...
					<button class="button">Criar Cotacao</button>
