  ...
  <c:when test="${fornecedor.id % 2 == 0}">
    <tr class="alternate-row">
                <td><input  type="checkbox"/></td>
                    ...
                    <td class="options-width">
                        <a href="edicaofornecedor?id=${fornecedor.id}" class="icon-1 info-tooltip" title="Editar Objeto"></a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="/delete?id=${fornecedor.id}" class="icon-4 info-tooltip" title="aaa"></a>
                         <a href="/edit?id=${fornecedor.id}" class="icon-3 info-tooltip" title="bbb"></a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="movimentacaofornecedor/delete?id=${fornecedor.id}" class="icon-5 info-tooltip" title="Delete Objeto"></a>
                    </td>
                </tr>
  </c:when>
  <c:when test="${fornecedor.id % 2 != 0}">
