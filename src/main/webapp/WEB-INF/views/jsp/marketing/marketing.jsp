...
<div id="conteudo" class="">
	<div class="post">
		...
		<button onclick="window.location.href='${pageContext.request.contextPath}/categoria/cadastro'"><p><img alt="kkk" src="${pageContext.request.contextPath}/resources/images/categoria.png">Cupom</p></button>
		<button onclick="window.location.href='${pageContext.request.contextPath}/produto/cadastro'"><p><img alt="kkk" src="${pageContext.request.contextPath}/resources/images/produto.png">Oferta</p></button>
